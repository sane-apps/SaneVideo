...
enum AppError: LocalizedError, Identifiable {
    ...
    var recoverySuggestion: String? {
        ...
        case .screenCaptureUnavailable:
            "Open System Settings > Privacy & Security > Screen & System Audio Recording and enable access for SaneVideo, then restart the app."
        case .noCameraFound:
...
extension AppError {
    ...
    var userFacingMessage: String {
        ...
        case .screenCaptureUnavailable:
            return "SaneVideo needs Screen & System Audio Recording access before it can capture your screen. Enable it in System Settings, then restart SaneVideo."
        case .diskSpaceLow:
    ...
    var recoverySuggestions: [String] {
        ...
        case .screenCaptureUnavailable:
            return [
                "Open System Settings → Privacy & Security",
                "Enable Screen & System Audio Recording for SaneVideo",
                "Restart SaneVideo after granting permission",
            ]
        case .projectLoadFailed:
            return [
