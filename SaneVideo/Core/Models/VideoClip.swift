...
struct VideoClip: Identifiable, Equatable, Hashable, Codable, Sendable {
  ...
  init(
    url: URL, duration: CMTime, startTime: CMTime = .zero, trimStart: CMTime = .zero,
  ...
  static func == (lhs: VideoClip, rhs: VideoClip) -> Bool {
    lhs.id == rhs.id && lhs.trimStart == rhs.trimStart && lhs.trimEnd == rhs.trimEnd
      && lhs.removedRanges == rhs.removedRanges && lhs.startTime == rhs.startTime
      && lhs.rotation == rhs.rotation && lhs.volume == rhs.volume && lhs.isMuted == rhs.isMuted
      && lhs.transition == rhs.transition && lhs.overlays == rhs.overlays
      && lhs.effects == rhs.effects && lhs.isVoiceIsolationEnabled == rhs.isVoiceIsolationEnabled
      && lhs.isGatingEnabled == rhs.isGatingEnabled && lhs.thumbnailURL == rhs.thumbnailURL
  ...
  init(from decoder: Decoder) throws {
    ...
    removedRanges =
      try container.decodeIfPresent([CodableTimeRange].self, forKey: .removedRanges) ?? []
    ...
    privacyRegions =
      try container.decodeIfPresent([PrivacyRegion].self, forKey: .privacyRegions) ?? []
    isVoiceIsolationEnabled =
      try container.decodeIfPresent(Bool.self, forKey: .isVoiceIsolationEnabled) ?? false
    isGatingEnabled = try container.decodeIfPresent(Bool.self, forKey: .isGatingEnabled) ?? false
    thumbnailURL = try container.decodeIfPresent(URL.self, forKey: .thumbnailURL)

    // FIX: Decode missing properties
    opacity = try container.decodeIfPresent(Double.self, forKey: .opacity) ?? 1.0
    enhancedAudioURL = try container.decodeIfPresent(URL.self, forKey: .enhancedAudioURL)
    keyframeAnimation = try container.decodeIfPresent(
      KeyframeAnimation.self, forKey: .keyframeAnimation)
  }
  ...
  func encode(to encoder: Encoder) throws {
    ...
    // FIX: Encode missing properties
    try container.encode(opacity, forKey: .opacity)
    try container.encodeIfPresent(enhancedAudioURL, forKey: .enhancedAudioURL)
    try container.encodeIfPresent(keyframeAnimation, forKey: .keyframeAnimation)
  }
}
