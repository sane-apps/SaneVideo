...
enum EffectCategory: String, CaseIterable {
    ...
    var displayName: String {
        ...
        case .adjustments: return String(localized: "effect.category.adjustments", defaultValue: "Adjust")
...
enum VideoEffectType: String, Codable, CaseIterable, Identifiable {
    ...
    nonisolated var category: EffectCategory {
        ...
        case .autoEnhance, .autoWhiteBalance:
            return .magic
        case .noir, .chrome, .fade, .instant, .mono, .tonal, .sepia, .colorInvert, .posterize, .falseColor, .thermal, .lut:
            return .looks
        case .brightness, .contrast, .saturation, .exposure, .vibrance, .highlights, .sharpen, .warmth:
            return .adjustments
        case .vignette, .bloom, .comic, .pixellate, .edges, .crystallize, .pointillize, .hexagonalPixellate:
            return .stylize
        case .blur, .motionBlur, .zoomBlur, .bokeh, .backgroundBlur:
            return .blur
        }
    }
    ...
    nonisolated var displayName: String {
        ...
        case .autoWhiteBalance: return String(localized: "effect.type.color_fix", defaultValue: "Color Fix")
        ...
        case .falseColor: return String(localized: "effect.type.false_color", defaultValue: "False Color")
        ...
        case .crystallize: return String(localized: "effect.type.crystallize", defaultValue: "Crystallize")
        case .pointillize: return String(localized: "effect.type.pointillize", defaultValue: "Pointillize")
        ...
        case .backgroundBlur: return String(localized: "effect.type.background", defaultValue: "Background")
        }
    }
    ...
    nonisolated var isBinary: Bool {
        switch self {
        case .autoEnhance, .autoWhiteBalance, .noir, .chrome, .fade, .instant, .mono, .tonal, .comic, .edges, .colorInvert, .thermal:
            return true
        default:
            return false
        }
...
struct VideoEffect: Identifiable, Codable, Equatable, Sendable {
    ...
    nonisolated init(type: VideoEffectType, intensity: Float? = nil) {
        self.type = type
    ...
    nonisolated func createFilter() -> CIFilter? {
        // Special effects handled differently in EffectsEngine
        switch type {
        case .autoEnhance, .autoWhiteBalance, .backgroundBlur:
            return nil
        default:
            break
        }
