...
class PiPControlsWindow: NSPanel {
    ...
    private func setupWindow() {
        ...
        level = .statusBar // Match parent PiP level
        isOpaque = false
        ...
        let hostingView = NSHostingView(rootView: controlsView.environment(ServiceContainer.shared.appState))
